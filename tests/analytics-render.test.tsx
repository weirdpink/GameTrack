...
beforeAll(() => {
  useGameTrackStore.setState({
    games: [
      { id: 1, title: "God of War", status: "completed", playtime: 42.5, hide_playtime: 0, date_added: 1786353000000, date_completed: 1786353000000, created_at: 1786353000000, updated_at: 1786353000000, genres: ["Adventure"], rawg_id: 19560, year: 2018, synopsis: "x", poster_url: "", critic_score: 94, owned_platforms: ["pc"], personal_rating: 9 },
      { id: 2, title: "Wallpaper Engine", status: "backlog", playtime: 0.5, hide_playtime: 0, date_added: 1786353000000, date_completed: null, created_at: 1786353000000, updated_at: 1786353000000, genres: [], rawg_id: null, year: null, synopsis: "", poster_url: "", critic_score: null, owned_platforms: ["steam"], personal_rating: null },
      { id: 3, title: "The Witcher 3", status: "playing", playtime: 8, hide_playtime: 0, date_added: 1786353000000, date_completed: null, created_at: 1786353000000, updated_at: 1786353000000, genres: ["RPG"], rawg_id: 1, year: 2015, synopsis: "", poster_url: "", critic_score: 93, owned_platforms: [], personal_rating: null },
    ],
    genreAnalytics: [
